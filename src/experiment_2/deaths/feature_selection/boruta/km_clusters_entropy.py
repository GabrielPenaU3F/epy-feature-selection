...
fig.savefig('../../../../../resources/results/experiment_2/deaths/boruta_km_entropy_importance_mdi.pdf')
ax.clear()
...
fig.savefig('../../../../../resources/results/experiment_2/deaths/boruta_km_entropy_importance_permutation.pdf')
