...
fig.savefig('../../../../resources/results/experiment_2/boruta_km_gini_importance_mdi.pdf')
ax.clear()
...
fig.savefig('../../../../resources/results/experiment_2/boruta_km_gini_importance_permutation.pdf')
