...
fig.savefig('../../../../resources/results/experiment_2/forest_fd_jenks_entropy_importance_mdi.pdf')
ax.clear()
...
fig.savefig('../../../../resources/results/experiment_2/forest_fd_jenks_entropy_importance_permutation.pdf')
